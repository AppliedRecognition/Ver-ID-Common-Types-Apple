...
final class FaceTests: XCTestCase {
    ...
    func testCreateFace() {
        _ = Face(bounds: .zero, angle: .identity, quality: 10, landmarks: [])
    }
    ...
    func testSortFaces() {
        ...
        let faces = zip(rects, qualities).map {
            Face(bounds: $0.0, angle: .identity, quality: $0.1, landmarks: [])
        }
    ...
    func testApplyMirrorTransform() {
        ...
        let face = Face(bounds: CGRect(x: 10, y: 20, width: 200, height: 300), angle: .identity, quality: 10, landmarks: [CGPoint(x: 60, y: 120), CGPoint(x: 160, y: 120)])
    ...
    func testChangeFaceAspectRatio() {
        let face = Face(bounds: CGRect(x: 10, y: 20, width: 200, height: 200), angle: .identity, quality: 10, landmarks: [])
